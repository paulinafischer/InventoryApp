...
import com.example.android.inventoryappstage2.sampledata.InventoryContract;
import com.example.android.inventoryappstage2.sampledata.InventoryContract.InventoryEntry;


/**
 * Created by Paulina on 7/3/2018.
 */
        ...
        mProductSupplieNameSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (!TextUtils.isEmpty(selection)) {
                    ...
                    } else if (selection.equals(getString(R.string.supplier_zalando))) {
                        mSupplieName = InventoryContract.InventoryEntry.SUPPLIER_ZALANDO;
                    } else if (selection.equals(getString(R.string.supplier_otto))) {
                        mSupplieName = InventoryContract.InventoryEntry.SUPPLIER_OTTO;
                    } else {
        ...
        if (cursor.moveToFirst()) {
            ...
            switch (currentSupplierName) {
                case InventoryEntry.SUPPLIER_AMAZON:
                    ...
                    break;
                case InventoryEntry.SUPPLIER_ZALANDO:
                    mProductSupplieNameSpinner.setSelection(2);
                    break;
                case InventoryEntry.SUPPLIER_OTTO:
