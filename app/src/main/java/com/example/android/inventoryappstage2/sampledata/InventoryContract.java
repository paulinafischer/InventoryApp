package com.example.android.inventoryappstage2.sampledata;
...
/**
 * Created by Paulina on 6/14/2018.
 */
...
public class InventoryContract {
    ...
    public final static class InventoryEntry implements BaseColumns {
        ...
        public final static int SUPPLIER_ZALANDO = 2;
        public final static int SUPPLIER_OTTO = 3;

        public static boolean isValidSupplierName(int suppliername) {
            if (suppliername == SUPPLIER_UNKNOWN || suppliername == SUPPLIER_AMAZON || suppliername == SUPPLIER_ZALANDO || suppliername == SUPPLIER_OTTO) {
                return true;
            }
            return false;
        }
